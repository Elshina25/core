module.exports = {
  ...
  theme: {
    ...
    screens: {
      ...
      'lg-only': { min: '1024px', max: '1239px' }, // tablet only
      'xl-only': { min: '1240px', max: '1439px' }, // tablet only
      '2xl-only': { min: '1440px' }, // desktop only

      mobile: { max: '767px' }, // mobile only
      tablet: { max: '1023px' }, // mobile only
      device: { max: '1239px' } // mobile and tablet
    },
    colors: {
      inherit: 'inherit',
