<template>
  ...
  >
    ...
    <div class="form__col">
      ...
      <b-button class="mb-8 2xl:mb-10" variant="white-green" transparent>
        Отправить заявку
      </b-button>
...
import { PHONE_MASKA, AGREEMENT_LINK, GREEN_THEME } from '@/config/form.config'
...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    subtitle:
      'Предоставим необходимую информацию об объекте и ответим на все интересующие вопросы'
  }
)
