...
class Version20222151120221115154748 extends Version
{
    protected $description = "Для раздела Исследования - инфоблок \"Руководители и сотрудники\"";
  ...
  'CODE' => 'persons',
  'API_CODE' => 'persons',
  'NAME' => 'Руководители и сотрудники',
  'ACTIVE' => 'Y',
  'SORT' => '10',
  'LIST_PAGE_URL' => '#SITE_DIR#/persons/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/persons/detail.php?ID=#ELEMENT_ID#',
