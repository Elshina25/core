...
class IBLOCK_research_fact20230124180552 extends Version
{
    protected $description = "Фактоиды для исследований";
  ...
  'CODE' => 'research_fact',
  'API_CODE' => 'researchfact',
  'NAME' => 'Фактоиды исследований',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/analytics/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/analytics/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/analytics/list.php?SECTION_ID=#SECTION_ID#',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'FILE_TYPE' => '',
  'MULTIPLE_CNT' => '5',
  'LINK_IBLOCK_ID' => 'analytics:analitics',
  'WITH_DESCRIPTION' => 'N',
  'SEARCHABLE' => 'N',
  'FILTRABLE' => 'N',
  'IS_REQUIRED' => 'Y',
  ...
  array (
    ...
    'PROPERTY_RESEARCH' => 'Исследование',
    'PROPERTY_ARROW' => 'Стрелка',
    'PREVIEW_TEXT' => 'Подзаголовок',
  ...
  'current_view' => 'default',
        ...
        $iblockId = $helper->Iblock()->getIblockIdIfExists("analitics");
        $helper->Iblock()->deletePropertyIfExists($iblockId, "FACT_TITLE");
        $helper->Iblock()->deletePropertyIfExists($iblockId, "FACT_DESC");
    }
