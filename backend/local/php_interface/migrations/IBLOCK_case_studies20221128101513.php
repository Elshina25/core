...
class IBLOCK_case_studies20221128101513 extends Version
{
    protected $description = "Настройки инфоблока \"Реализованные проекты\"";
  ...
  array (
    ...
    'PROPERTY_SERVICES' => 'Привязка к услуге',
    'PROPERTY_PERSON' => 'Контакты директора',
    'PROPERTY_PHOTOS' => 'Фотографии',
    'PROPERTY_QUOTETEXT' => 'Цитата',
    'PROPERTY_QUOTEAUTHOR' => 'Автор цитаты',
  ),
  'Анонс|edit5' => 
  array (
